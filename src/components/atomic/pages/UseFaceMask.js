...
// export const useFaceMask = (videoElement, canvasElement, filterUrl) => {
//   const [model, setModel] = useState();
...
//       requestRef.current = requestAnimationFrame(animate);
//     }
//   }, [model, videoElement, faceCanvas, canvasElement, filterUrl]);
...
// class FaceCanvas {
//   constructor({ canvas, filterUrl, w, h }) {
...
//     const texture = this._textureLoader.load(this._filterUrl);
